...
setup(
    ...
    version="4.9",                                   # The version of the module.
    ...
    install_requires=[
        ['p3lib>=1.1.44','tornado>=6.1','pymodbus>=2.5.2'],            # A python list of required module dependencies (optionally including versions)
    ],
